...
* Web3 integration partners (Alchemy, Web3Auth, Blazing Core, Filebase ++)
...
Finally, replace the rair-front image hash in the default Blazing Core configuration with your own rair-front image.


> Don't forget to whitelist your Blazing Core URL in Web3Auth for social logins to work!
