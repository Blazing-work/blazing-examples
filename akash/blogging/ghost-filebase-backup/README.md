...
Deploy Ghost blog  with automatic IPFS backup via Filebase.

在 Blazing Core 上部署 Ghost 博客，通过 Filebase 实现自动 IPFS 备份。
...
将您的域名 DNS 指向 Blazing Core 提供商分配的 URI。
