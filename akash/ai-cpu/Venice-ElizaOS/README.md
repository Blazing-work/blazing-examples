# Launching an Eliza Agent using Venice API


This is a template for launching an Eliza Agent with direct interaction and Twitter/X integration . This enables users to input their Venice API Key, Twitter Credentials, and Character information to get the Eliza agent up and running. You will need a Venice API key for this to work properly.
...
## Usage
To launch an Eliza Agent using Venice API through Blazing Core, you need to follow the following instructions:
