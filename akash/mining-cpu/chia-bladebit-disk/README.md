...
For the following providers expect to see these prices Console! Each provider has been benchmarked and tested to create a $0.15/plot. &#x20;
...
For a complete guide on how to customize the SDL, including configuring rclone and ssh destinations please see [Chia](https://akash.network/docs/guides/blockchain/chia-on-akash/)
