...
# Easier deployment
If you do not wish to manage your deployment manually, you can use the deployment script repository at https://github.com/slowriot/akash_minecraft - this will deploy the server to Blazing Core with a single command, automatically selecting the lowest bidder, and providing you with links to the server and the log streams.
