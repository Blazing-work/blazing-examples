...
Optimize performance by choosing the right worker type for CPU-intensive vs I/O-bound tasks.

## Metadata
- **Product**: Blazing Flow
- **Difficulty**: Intermediate
- **Time**: 20 min
- **Tags**: performance, optimization, worker-types, cpu, io

## Description

Blazing automatically optimizes execution by using different worker pools. Use `step_type='BLOCKING'` for CPU-intensive work and default (NON_BLOCKING) for I/O-bound operations. This prevents CPU tasks from blocking async I/O operations.

## What you'll learn

- When to use BLOCKING vs NON_BLOCKING workers
- How to optimize CPU-intensive computations
- How to optimize I/O-bound API calls
