...
Process large batches of stock data with throttling and error handling.

## Metadata
- **Product**: blazing-flow
- **Difficulty**: Advanced
- **Time**: 15 min
- **Tags**: batch, stocks, throttling, resilient, fintech

## Description

This example demonstrates batch processing patterns inspired by financial data
pipelines. Process hundreds of stocks efficiently with:

- Batch processing with configurable sizes
- Throttling to respect API rate limits
- Resilient error handling (partial failures don't stop the batch)
...
- Throttling strategies (fixed window, rolling window)
- Resilient batch processing with error collection
- Progress tracking in long-running workflows
"""
