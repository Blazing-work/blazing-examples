...
Run untrusted user code safely in WASM sandbox with zero network or filesystem access.
...
- How to mark steps as sandboxed with `@app.step(sandboxed=True)`
- Security guarantees of WASM isolation
- When to use sandboxed vs trusted execution
- Performance characteristics of sandboxed code
"""
