...
ENDPOINTS_DOCS = "/Users/jonathanborduas/code/blazing-docs/blazing-flow/endpoints/examples.mdx"
SANDBOX_DOCS = "/Users/jonathanborduas/code/blazing-docs/blazing-flow-sandbox/examples.mdx"
...
def create_example_file(example_metadata):
    ...
    if 'heading' in example_metadata:
        code = extract_code_by_heading(example_metadata['source'], example_metadata['heading'])
    else:
        code = extract_code_from_mdx(example_metadata['source'], example_metadata['example_num'])
